...
[数据流水线](docs/cn/guide/data-pipeline.md) 指南。

## 📚 文档

完整的设计规范与使用指南在 **[docs/](docs/cn/README.md)**：

- **从这里开始：** [快速上手](docs/cn/guide/getting-started.md)
- **数据与正确性：** [数据与复权](docs/cn/guide/data-and-adjustment.md)
  （[English](docs/en/guide/data-and-adjustment.md)）—— 数据层、点对点读取，以及因子在
  **拆股与分红** 下看到的价格。
- **指南：** [数据流水线](docs/cn/guide/data-pipeline.md) · [Python SDK](docs/cn/guide/python-sdk.md) ·
  [CLI](docs/cn/guide/cli.md) · [REST API](docs/cn/guide/rest-api.md) · [MCP](docs/cn/guide/mcp-server.md) ·
  [WebUI](docs/cn/guide/webui.md) · [因子合成](docs/cn/guide/factor-combination.md) ·
  [组合回测](docs/cn/guide/portfolio-backtest.md) · [性能](docs/cn/guide/performance.md)
- **设计：** [工程](docs/cn/design/engineering.md) · [架构](docs/cn/design/architecture.md) ·
  [算子对照表](docs/cn/design/operator-compatibility.md) · [组合](docs/cn/design/portfolio-backtest.md)
...
[docs/cn/design/operator-compatibility.md](docs/cn/design/operator-compatibility.md)：
...
> 在这些内核之上——见 [文档指南](docs/cn/README.md)。
